      ...
      <div id="title-2-active-projects" className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200">
        ...
        <div className="mb-10 rounded-2xl border-2 border-sky-300 bg-gradient-to-br from-white via-sky-50/20 to-blue-50/40 p-6 sm:p-7 shadow-sm">
          ...
          <div className="bg-white rounded-xl p-4 sm:p-5 border border-slate-200 shadow-2xs mb-6 text-xs sm:text-sm text-slate-700 leading-relaxed space-y-3">
            <p>
              The <strong className="font-bold text-slate-900">FARBOD RAD Management Team Program</strong> represents an integrated cluster of eight (8) world-class teaching, training, and treatment hospital facilities. In 2025, a landmark PPP Funding Facility Agreement was formally executed between the <strong className="font-bold text-slate-900">FARBOD RAD Management Team</strong> and <strong className="font-bold text-slate-900">MUJTAMEASAHAMDARAN TOSEA ASIAVE</strong>, establishing a committed capital development obligation of <strong className="font-bold text-slate-900">120 million Euro</strong>.
            </p>
            <p>
              All transaction procedures, compliance verification, and concession structuring will continue to be carried out under the strict monitoring, governance auditing, and advisory supervision of the <strong className="font-bold text-[#0072bc]">PPP Union</strong>. Physical works are scheduled within a fixed <strong className="font-bold text-slate-900">38-month execution framework</strong>, to be initiated upon operational clearance, ensuring that FARBOD RAD remains fully committed to delivering ethical, uninterrupted, and world-class hospital infrastructure.
            </p>
          </div>
